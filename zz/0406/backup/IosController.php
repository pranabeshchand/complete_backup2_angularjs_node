                   ...
                   preg_match_all('~<img.*?src=["\']+(.*?)["\']+~', $comms['Comment']['comment'], $urls);
                     ...
                     if(sizeof($urls[1]) >= 1){
                        foreach ($urls[1] as $urlimg) {
                            $arr .= FULL_BASE_URL .$this->webroot.$urlimg." ";
                        }
                   } 
...
//                $response['resp']=$luser;
   ...
   $target = "f5DdmNwdlrM:APA91bEyeOugPaDLWD3v3fRpU6FUyjqor9w-682JptMoM4CfqLr3y-rou8YVbgCIArYUC1mQ4naJvYDHmzvoDQW0sIyHDrPNqBxNJIW4ZdGeuuZezxIVQ_vuPQ0RtAzDeb0zE0sPi9NB";         
